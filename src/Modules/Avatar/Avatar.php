 ...
 * @method static \Simtabi\Laranail\Toolkit\Modules\Avatar\AvatarResolution getAvatar(string|\Illuminate\Database\Eloquent\Model|callable $source, array<string, mixed> $options = [])
