...
| `Laravel/Observers/BaseObserver` | ✅ **RESTORED (G8)** → `Observers\BaseObserver` (reusable model-observer base). | `Observers\BaseObserver`. | (in-repo) `src/Observers/BaseObserver.php` |
