...
class GeoHelperTest extends TestCase
{
    public function test_distance_between_london_and_paris_in_km(): void
    {
        ...
        $distance = GeoHelper::distanceBetween(51.5074, -0.1278, 48.8566, 2.3522);
    ...
    {
        $this->assertSame(0.0, GeoHelper::distanceBetween(10.0, 20.0, 10.0, 20.0));
    }

    public function test_unit_conversion_is_consistent(): void
    {
        $km = GeoHelper::distanceBetween(51.5074, -0.1278, 48.8566, 2.3522, 'km');
        $mi = GeoHelper::distanceBetween(51.5074, -0.1278, 48.8566, 2.3522, 'mi');
        $m = GeoHelper::distanceBetween(51.5074, -0.1278, 48.8566, 2.3522, 'm');
        $nmi = GeoHelper::distanceBetween(51.5074, -0.1278, 48.8566, 2.3522, 'nmi');
    ...
    public function test_unsupported_unit_throws(): void
    {
        ...
        GeoHelper::distanceBetween(0.0, 0.0, 1.0, 1.0, 'furlongs');
    }
}
