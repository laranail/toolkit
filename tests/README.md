...
This directory contains comprehensive unit and feature tests for the Laranail package.
...
When adding new functionality to Laranail, follow these guidelines:
